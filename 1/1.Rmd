...
meta() %>% 
  ...
  meta_social(
    title = params$title,
    url = paste0("https://samgoeta.github.io/", params$slug),
    image = params$image,
...
---
### Peut-on se priver de chiffre en politique ? 
...
---
### Les données s'imposent à nous comme des .red[arguments d'autorité]

#### On peut débattre de tout… sauf des chiffres ?

.center[
<iframe width="560" height="315" src="https://www.youtube.com/embed/uUZDWW7V36A?si=J8BdYcNJcpbAs8h8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
]

---
### On aurait néanmoins tort de vouloir se passer des chiffres
...
---
### Le monde post-statistique ?

.pull-left[
William Davies (2017), "[_Comment la statistique a perdu son pouvoir – et pourquoi nous devrions craindre ce qui va suivre ?_](https://www.persee.fr/doc/staso_2269-0271_2017_num_5_1_1018)" : 

- L'aversion pour la statistique : un des traits du populisme, au coeur de la post-vérité 

- L'histoire tri-séculaire de la statistique : dépeindre une société de manière globale et objective

- Big data : pluralité de sources de données, risque de privatisation du chiffre
...
---
### Les dangers du monde post-statistique 

.pull-left[
![](img/wired-epa.png)
L'agence de protection de l'environnement américaine (EPA) met fin aux obligations de reporting des émissions de gaz à effet de serre. 

]

.pull-right[
- Sans ces données, il devient impossible de suivre si les industries maintiennent leur effort de décarbonisation. Le gouvernement ne peut plus mettre en œuvre une politique climatique.

- Les données des acteurs non-gouvernementaux (détection par IA) ne sont pas accessibles à tous et ne peuvent pas être utilisées devant les tribunaux.
...
---
### Un cours sur une ligne de crête

.pull-left[


.reduite[![](https://www.interforum.fr/images/DEC/P3/9782355220548.jpg)]
]

.pull-right[
**Développer une culture critique de la quantification, ses sources et ses limites**

**Apprendre à mobiliser la force rhétorique des chiffres et de la dataviz pour le plaidoyer**

> "Le parti-pris de ce livre procède du judo : prolonger le mouvement de l'adversaire afin de détourner sa force et la lui renvoyer en pleine face, faire de la statistique une arme critique."
...
1. **03/10 :** Sociohistoire de la statistique (.red[**vous êtes ici !**])

2. **07/10 :** La construction sociale des chiffres

3. **14/10** : Les acteurs de la statistique et de la quantification

4. **14/11 :** Collecter et évaluer les chiffres

5. **11/11 :**Visualiser les données
