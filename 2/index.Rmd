...
> Comment comprendre, en effet, qu’elle soit convoquée tantôt comme un « outil de gouvernement », depuis le xviiie siècle (Foucault, 2004), tantôt comme un « outil de preuve », depuis le xixe siècle, avec le développement de la statistique mathématique et son association de plus en plus étroite avec le calcul des probabilités (Stigler, 1986) ?
...
- Statistique : historiquement construite et légitimée à partir du modèle des sciences de la nature. 
